...
public class AESUtil {
    ...
    public static String encrypt(String content, String key) {
        try {
            ...
            return new BASE64Encoder().encode(encode_content);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static String decrypt(String encryptStr, String decryptKey) {
        try {
            ...
            byte [] encode_content = new BASE64Decoder().decodeBuffer(encryptStr);
            //密码器解密数据
    ...
    public static void main(String[] args) {
        ...
        String str = encrypt("12345678", substring);
        System.out.println(str);

        String str2 = decrypt(str, substring);
